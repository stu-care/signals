...
/*
 * Banner repeater — a black bar on a white disc that pre-warns you of a signal
 * whose sighting is poor. Horizontal bar = the signal ahead is at DANGER; bar
 * inclined up to the right = the signal ahead is "off" (a proceed aspect, which
 * includes a single yellow). It is not itself a signal you obey.
 */
export const bannerRepeaterFamily: SignalFamily = {
  ...
  intro:
    'A banner repeater gives you an early read of a signal whose own sighting is poor — hidden by a curve, a bridge or a long platform. It repeats only whether that signal is “off” (a proceed aspect) or at danger. You still obey the actual signal when you reach it; the banner just lets you plan ahead.',
  variants: [
    {
      id: 'banner',
      name: 'Banner repeater',
      shortName: 'Banner',
      blurb: 'Horizontal bar = signal ahead at danger; inclined bar = signal ahead is off.',
      panels: [{ type: 'arm', id: 'banner', kind: 'banner', label: 'Banner bar' }],
      aspects: [
        {
          id: 'on',
          name: 'Horizontal bar',
          ...
          whatYouDo: 'Control your speed so you can stop at the signal ahead, which is showing a red.',
          lookAlikes:
